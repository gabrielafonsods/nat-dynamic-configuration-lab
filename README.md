🌐 Laboratório de NAT Dinâmico (Cisco Packet Tracer)
📌 Visão geral

Este projeto consiste na configuração de NAT Dinâmico (Network Address Translation) em um ambiente simulado no Cisco Packet Tracer. O objetivo é permitir que dispositivos de uma rede interna utilizem um conjunto de endereços públicos para comunicação com redes externas.

🎯 Objetivos
Configurar NAT Dinâmico em roteador Cisco
...
PCs e switches virtuais
Configuração via CLI (Command Line Interface)
dor
